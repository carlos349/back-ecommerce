            ...
            .then(client => {
                ...
                .then(promotion => {
                    const mail = {
                        from: Mail[0].mail,
                        bcc: sendMails,
                        subject: 'Nueva promoción de '+Mail[0].website,
                        html: `
                        <!doctype html>
                          ...
                          <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="border-collapse:separate;line-height:100%;">
                            <tr>
                              <td align="center" bgcolor="#A7A7A7" role="presentation" style="border:0px #000 solid;border-radius:25px;cursor:auto;mso-padding-alt:10px 30px;background:#A7A7A7;" valign="middle">
                                <a href="${Mail[0].website}" style="display:inline-block;background:#A7A7A7;color:#1F1F1F;font-family:Bitter, Georgia, serif;font-size:15px;font-weight:normal;line-height:100%;Margin:0;text-decoration:none;text-transform:none;padding:10px 30px;mso-padding-alt:0px;border-radius:25px;" target="_blank">
                                  VER MÁS
                                </a>
                              </td>
                            </tr>
            ...
            .then(client => {
                ...
                .then(products => {
                    const mail = {
                        from: Mail[0].mail,
                        to: client.mail,
                        subject: 'Bienvenido a '+Mail[0].mail,
                        html: `
